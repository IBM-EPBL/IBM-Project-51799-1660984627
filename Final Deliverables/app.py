...
ACCOUNT_NAME, API_KEY="bd84549c-d8e0-47c4-9fac-c68107bcf136-bluemix","M2omO01qPVjfoQ0tmEoHfmWIJiYVYIu2JpT9w0puZ1h0"
...
def res():
    ...
    while webcam.isOpened():
        ...
        if(isDrowning==True):
            ...
            #playsound(audio)
            playsound("C:\\Users\\SAI\\Downloads\\IBM-Project-2094-1658428458-main\\IBM-Project-2094-1658428458-main\\Project development phase\\sprint 2/a.mp3")
            webcam.release()
